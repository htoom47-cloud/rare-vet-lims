  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 mb-1.5">
        ...
        <h3 className={cn('font-semibold text-[#111827] dark:text-[#F9FAFB]', compact ? 'text-xs' : 'text-sm')}>
          {t('portal.clinicalInterpretation')}
        </h3>
      </div>
      <p className={cn('leading-relaxed text-[#6B7280] dark:text-[#D1D5DB]', compact ? 'text-[11px]' : 'text-sm')}>{text}</p>
    </div>
  );
}
