...
export const hatifAPI = {
  ...
  openWhatsApp: (customerId) => api.post(`/hatif/customers/${customerId}/whatsapp/open`),
...
export const billingAPI = {
  ...
  creditNotes: (invoiceId) => api.get(`/billing/invoices/${invoiceId}/credit-notes`),
  ...
  zatcaProductionCsid: () => api.post('/billing/zatca/production-csid'),
  submitInvoiceZatca: (id) => api.post(`/billing/invoices/${id}/zatca-submit`),
  submitAllInvoicesZatca: () => api.post('/billing/invoices/zatca-submit-all'),
  ...
  deactivateDiscountPreset: (id) => api.delete(`/billing/discount-presets/${id}`),
