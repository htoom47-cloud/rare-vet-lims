...
const LAB_REPORT_PRINT_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .lab-rpt-table th { padding: 3px 4px; font-size: 7pt; font-weight: 600; text-transform: uppercase; }
  .lab-rpt-table td { padding: 2px 4px; vertical-align: middle; border-bottom: 1px solid #e8e0d8; }
  ...
  .lab-rpt-panel-row td { padding: 3px 6px !important; background: #5B3A29; color: #F7F5F2; border-bottom: none; }
