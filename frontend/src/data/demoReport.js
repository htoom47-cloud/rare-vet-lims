...
export const DEMO_REPORT = {
  ...
  results: [
    ...
    { testCode: 'CHEM-BASIC', categoryCode: 'CHEM', testNameAr: 'لوحة الكيمياء الأساسية', testNameEn: 'Basic Chemistry Panel', code: 'BUN', nameAr: 'اليوريا', nameEn: 'Urea', value: '38', unit: 'mg/dL', reference: '10 - 30', flag: 'HIGH', isCritical: false, instrument: 'Diasys Respons 910' },
