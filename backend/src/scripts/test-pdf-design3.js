/**
 * Generate sample Design 3 (HTML/CSS) report PDF.
 * Usage: node src/scripts/test-pdf-design3.js
 */
const path = require('path');
const { generateReportPDF } = require('../utils/report-designs/design-3');
...
generateReportPDF({
  ...
  results,
}, path.join(__dirname, '../../uploads/reports'), { filename: 'test-vetconnect-design3.pdf' })
