...
const mergeInvoiceSettings = (stored) => {
  ...
  // Contact/tax and brand names always follow deployment env — not stale DB overrides.
  merged.lab.name = defaults.lab.name;
  merged.lab.name_ar = defaults.lab.name_ar;
